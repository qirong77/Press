export const FilesIcon = (props: JSX.IntrinsicElements['button']) => {
  return (
    <IconContainer {...props}>
      <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2871">
        <path
...
export const SearchIcon = (props: JSX.IntrinsicElements['button']) => {
  return (
    <IconContainer {...props}>
      <svg
